...
-- 行の移動
set("n", "<C-M-j>", ":move .+1<CR>==", { desc = "Move line Down" })
set("x", "<C-M-j>", ":move '>+1<CR>gv=gv", { desc = "Move line Down" })
set("i", "<C-M-j>", "<Esc><Cmd>move .+1<CR>==gi", { desc = "Move line Down" })
set("n", "<C-M-k>", ":move .-2<CR>==", { desc = "Move line Up" })
set("x", "<C-M-k>", ":move '<-2<CR>gv=gv", { desc = "Move line Up" })
set("i", "<C-M-k>", "<Esc><Cmd>move .-2<CR>==gi", { desc = "Move line Up" })
